...
const defaultFeConfigs: FastGPTFeConfigsType = {
  ...
  appTemplateCourse: '',
  systemTitle: 'aispeech',
  // concatMd:
  //   '项目开源地址: [aispeech GitHub](https://github.com/aispeech/aispeech)\n交流群: ![](https://github.com/aispeech/aispeech/raw/main/docs/imgs/aispeech_qrcode.png)',
  concatMd: '',
  limit: {
